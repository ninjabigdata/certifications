		...
		<div class="row">
			<div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 col-12">
				<div class="card" style="height: 200px;">
					...
					<img alt="Online"
						src='<spring:url value="/resources/static/stay-online.png" style="width: fit-content; margin: auto;"></spring:url>'
						class="card-img-top" />
					<div class="card-body">
			...
			<div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 col-12">
				<div class="card" style="height: 200px;">
					...
					<img alt="Online"
						src='<spring:url value="/resources/static/smartphone.png" style="width: fit-content; margin: auto;"></spring:url>'
						class="card-img-top" />
					<div class="card-body">
			...
			<div class="col-xl-3 col-lg-3 col-md-3 col-sm-6 col-12">
				<div class="card" style="height: 200px;">
					...
					<img alt="Online"
						src='<spring:url value="/resources/static/smartwatch.png" style="width: fit-content; margin: auto;"></spring:url>'
						class="card-img-top" />
					<div class="card-body">
